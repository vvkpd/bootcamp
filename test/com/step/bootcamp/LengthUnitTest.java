...
public class LengthUnitTest {
  ...
  public void oneFootShouldReturn30Centimetres() {
    double oneFoot = LengthUnit.FEET.toCentimetres(1);
  ...
  public void twoPoint5FeetShouldReturn75Centimetres() {
    double twoPoint5Feet = LengthUnit.FEET.toCentimetres(2.5);
  ...
  public void oneInchShouldReturn2Point5Centimetres() {
    double oneInch = LengthUnit.INCH.toCentimetres(1);
  ...
  public void twoPoint5InchShouldReturn6Point25Centimetres() {
    double twoPoint5Inch = LengthUnit.INCH.toCentimetres(2.5);
  ...
  public void oneCentimetreShouldReturn1Centimetre() {
    double oneCM = LengthUnit.CENTIMETRES.toCentimetres(1);
  ...
  public void threeInchesShouldReturn7Point5Centimetres() {
    double threeInch = LengthUnit.INCH.toCentimetres(3);
  ...
  public void tenMMShouldReturn1CM() {
    double tenMM = LengthUnit.MILLIMETRES.toCentimetres(10);
    double oneCM = 1.0;
